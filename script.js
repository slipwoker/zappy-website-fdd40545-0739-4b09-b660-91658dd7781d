                    ...
                    fetch(formAction, fetchOptions)
                        .then(function(response) {
                            if (response.ok) {
                                ...
                                successMessage.style.cssText = 'color: #27ae60; padding: 1rem; margin-top: 1rem; background: #d5f5e3; border-radius: 4px;';
                        ...
                        .catch(function(error) {
                            ...
                            errorMessage.style.cssText = 'color: #e74c3c; padding: 1rem; margin-top: 1rem; background: #fadbd8; border-radius: 4px;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'fdd40545-0739-4b09-b660-91658dd7781d',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'fdd40545-0739-4b09-b660-91658dd7781d';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'fdd40545-0739-4b09-b660-91658dd7781d';
